...
def cmp_run_conv_nnet2_classif(seed, isize, ksize, bsize, ignore_error=False, n_iter=10):
    if ignore_error:
        numpy.random.seed(seed)
        rval_gpu, t = run_conv_nnet2_classif(tcn.shared_constructor, isize, ksize, bsize, n_iter)
        return
