...
def print_compiledir_content():
    ...
    for dir in os.listdir(compiledir):
        ...
        try:
            try:
                ...
                file = open(filename, 'rb')
                keydata = cPickle.load(file)
                ops = list([x for x in flatten(keydata.keys)
    ...
    print "sub directory/nb_ops/first_op/a list of the inputs variables types"
    ...
    table_op_class = sorted(table_op_class.iteritems(),
