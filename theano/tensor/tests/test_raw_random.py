...
class T_random_function(utt.InferShapeTester):
    ...
    def test_random_function_ndim_added(self):
        ...
        keyword argument"""
        # If using np's uniform distribution, ndim_added should be 0,
    ...
    def test_uniform(self):
        """Test that raw_random.uniform generates the same results as np."""
        ...
        np_rng = np.random.RandomState(utt.fetch_seed())
        val0 = f()
        val1 = f()
        np_val0 = np_rng.uniform(-2.0, 2.0, size=(4,))
        np_val1 = np_rng.uniform(-2.0, 2.0, size=(4,))
        self.assertTrue(np.allclose(val0, np_val0))
        self.assertTrue(np.allclose(val1, np_val1))
    ...
    def test_binomial(self):
        ...
        val0 = f()
        val1 = f()
        np_val0 = np_rng.binomial(5, 0.8, size=(7, 12))
        np_val1 = np_rng.binomial(5, 0.8, size=(7, 12))
        self.assertTrue(np.all(val0 == np_val0))
        self.assertTrue(np.all(val1 == np_val1))

    def test_normal(self):
        """Test that raw_random.normal generates the same results as np."""
        # Check over two calls to see if the random state is correctly updated.
        rng_R = random_state_type()
        # Use non-default parameters
        ...
        val0 = f()
        val1 = f()
        np_val0 = np_rng.normal(4.0, 2.0, size=(2, 3))
        np_val1 = np_rng.normal(4.0, 2.0, size=(2, 3))
        self.assertTrue(np.allclose(val0, np_val0))
        self.assertTrue(np.allclose(val1, np_val1))

    def test_random_integers(self):
        # Test that raw_random.random_integers generates the same
        # results as np.  We use randint() for comparison since
        ...
        val0 = f()
        val1 = f()
        np_val0 = np_rng.randint(-3, 17, size=(11, 8))
        np_val1 = np_rng.randint(-3, 17, size=(11, 8))
        self.assertTrue(np.allclose(val0, np_val0))
        self.assertTrue(np.allclose(val1, np_val1))
    ...
    def test_permutation_helper(self):
        ...
        val0 = f()
        val1 = f()
        # np_rng.permutation outputs one vector at a time,
        # so we call it iteratively to generate all the samples.
        np_val0 = np.asarray([np_rng.permutation(8)
                                    for i in range(7)])
        np_val1 = np.asarray([np_rng.permutation(8)
                                    for i in range(7)])
        self.assertTrue(np.all(val0 == np_val0))
        self.assertTrue(np.all(val1 == np_val1))
    ...
    def test_choice(self):
        ...
        val0 = f()
        val1 = f()
        np_val0 = np_rng.choice(10, (11, 8), True, None)
        np_val1 = np_rng.choice(10, (11, 8), True, None)
        self.assertTrue(np.allclose(val0, np_val0))
        self.assertTrue(np.allclose(val1, np_val1))
    ...
    def test_poisson(self):
        ...
        val0 = f()
        val1 = f()
        np_val0 = np_rng.poisson(5, size=(11, 8))
        np_val1 = np_rng.poisson(5, size=(11, 8))
        self.assertTrue(np.allclose(val0, np_val0))
        self.assertTrue(np.allclose(val1, np_val1))
    ...
    def test_permutation(self):
        ...
        val0 = f()
        val1 = f()
        np_val0 = np.asarray([np_rng.permutation(6)
                                    for i in range(9)])
        np_val1 = np.asarray([np_rng.permutation(6)
                                    for i in range(9)])
        self.assertTrue(np.all(val0 == np_val0))
        self.assertTrue(np.all(val1 == np_val1))
    ...
    def test_multinomial(self):
        ...
        val0, = f()
        val1, = f()
        np_val0 = np_rng.multinomial(6, [0.2] * 5, (7, 3))
        np_val1 = np_rng.multinomial(6, [0.2] * 5, (7, 3))
        self.assertTrue(np.all(val0 == np_val0))
        self.assertTrue(np.all(val1 == np_val1))
    ...
    def test_default_shape(self):
        ...
        post1, val1 = f(post0)
        np_val0 = np.asarray(np_rng.uniform(),
                                   dtype=theano.config.floatX)
        np_val1 = np.asarray(np_rng.uniform(),
                                   dtype=theano.config.floatX)
        ...
        post2, val2 = g(post1)
        np_val2 = np.asarray(np_rng.multinomial(n=1, pvals=[.5, .5]),
                dtype=theano.config.floatX)
    ...
    def test_vector_arguments(self):
        ...
        np_val0 = as_floatX(np_rng.uniform(low=[-5, .5, 0, 1], high=1))
        np_val1 = as_floatX(np_rng.uniform(low=as_floatX([.9]), high=1))
        ...
        np_val0b = as_floatX(np_rng.uniform(low=[-4., -2], high=[-1, 0]))
        np_val1b = as_floatX(np_rng.uniform(low=[-4.], high=[-1]))
        ...
        np_val0c = as_floatX(np_rng.uniform(low=[-4., -2], high=[-1, 0]))
        np_val1c = as_floatX(np_rng.uniform(low=[-4.], high=[-1]))
    ...
    def test_broadcast_arguments(self):
        ...
        np_val2 = np_rng.uniform(low=[-5, .5, 0, 1],
                                       high=[[1.], [1.1], [1.5]])

        assert np.all(val0 == np_val0), (val0, np_val0)
        assert np.all(val1 == np_val1)
        assert np.all(val2 == np_val2)
    ...
    def test_uniform_vector(self):
        ...
        np_val0 = as_floatX(np_rng.uniform(low=low_val, high=high_val))
        assert np.all(val0 == np_val0)

        # arguments of size (2,)
        rng1, val1 = f(rng0, low_val[:-1], high_val[:-1])
        np_val1 = as_floatX(np_rng.uniform(low=low_val[:-1],
                                                 high=high_val[:-1]))
        assert np.all(val1 == np_val1)
        ...
        np_val2 = as_floatX(np_rng.uniform(low=low_val, high=high_val,
                                                 size=(3,)))
        assert np.all(val2 == np_val2)
    ...
    def test_normal_vector(self):
        ...
        np_val0 = as_floatX(np_rng.normal(loc=as_floatX(avg_val),
            scale=as_floatX(std_val)))
        assert np.all(val0 == np_val0)

        # arguments of size (2,)
        rng1, val1 = f(rng0, avg_val[:-1], std_val[:-1])
        np_val1 = np.asarray(np_rng.normal(loc=avg_val[:-1],
                                                    scale=std_val[:-1]),
                dtype=theano.config.floatX)
        assert np.all(val1 == np_val1)
        ...
        np_val2 = np.asarray(np_rng.normal(loc=avg_val, scale=std_val,
                                                    size=(3,)),
                dtype=theano.config.floatX)
        assert np.all(val2 == np_val2)
