...
class AbstractTransformerGrid(Op):
...
class AbstractTransformerSampler(Op):
    ...
    def grad(self, inputs, grads):
        ...
        grad_inp, grad_grid = AbstractTransformerGradI(self.border_mode)(inp, grid, grad_outputs)
...
class AbstractTransformerGradI(Op):
