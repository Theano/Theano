...
def pydotprint(fct, outfile=None,
    ...
    In the graph, ellipse are an Apply Node(the execution of an op) and box are variable.
    ...
    green box are inputs to the graph
    blue box are outputs of the graph
    grey box are var generated by the graph that are not output and are not used.
